  ...
  render() {
    ...
    <div class="Resume">
        ...
        <div class="ResumeHeader">
            ...
            <p>23348 Esperanza Dr. &bull; Lexington Park, MD 20653</p>
            <p>
        ...
        <div class="ResumeSection">
            ...
            <div class="ResumeSectionItem ResumeKbrWyle">
                <div class="ResumeLeftRight">
                    <div>
                        <span class="ResumeItemHeader">Software Engineer:</span> KBRwyle, Lexington Park, MD
                    </div>
                    <div class="ResumeDate">July 2017 - present</div>
                </div>
                <div class="ResumeItemDescription">
                    <p>Maintain and develop web applications, develop and consume RESTful services and create data visualizations utilizing:</p>
                    <p>C#, ASP.NET MVC, Web Api, Web Forms, </p>
                    <p>Json.NET, Ninject dependency injection, NUnit/moq unit testing, </p>
                    <p>Microsoft Sql Server, T-SQL, Entity Framework,</p>
                    <p>JavaScript, jQuery, D3, TypeScript, Kendo UI, CSS, Bootstrap, HTML, </p>
                    <p>Java, Gson</p>
                </div>
            </div>
        ...
        <div class="ResumeSectionItem ResumeNotableProgramsBuilt">
            ...
            <div class="ResumeItemDescription">
                ...
                <ul class="ResumeAlgorithmic">
                    ...
                    <li>Scheduling program based on the AC-3 algorithm utilizing Apache POI API to import from excel documents
                        written in Scala</li>
                ...
                <ul class="ResumeWebPrograms">
                    <li>Map making web application developed with nodejs, typescript and Angular 2 manipulating uploaded images
                        using js canvas operations</li>
                    <li>Calendar making application developed with nodejs, webpack, typescript, react, Moment.js, material ui
                        and PptxGenJS that generates a powerpoint of calendar with calendar events for the year</li>
                ...
                <ul class="ResumeDesktopPrograms">
                    ...
                    <li>Music composition software for young students built in java utilizing the libgdx library for cross-platform
                        deployment: processes PCM audio data, utilizes the web audio javascript API, visualizes music in
        ...
        <div class="ResumeSectionItem ResumeLangaugesAndTechnologies">
            ...
            <ul>
                <li>Experienced in Java, C, C#, F#, TypeScript, Javascript/HTML/CSS, jQuery</li>
                <li>Working knowledge of Amazon AWS, Google App Engine, Heroku, shell scripting, PHP, Dart, Rust, OCaml, React,
                    Python, Scala, SQL</li>
