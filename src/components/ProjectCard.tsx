...
const ProjectCard = (props: {
  ...
  return (
    <div className="m-2.5 inline-block max-w-87.5 rounded-lg bg-card text-left align-top text-body shadow-md">
      <a href={href} className="block">
        <img
          src={img}
          title={header}
          alt={header}
          className="h-50 w-full object-cover rounded-t-lg brightness-80 transition-[filter] duration-500 hover:brightness-100"
        />
      </a>
      <div className="p-4">
