  ...
  render() {
    return (
      <div className="Resume">
        ...
        <p><strong>Software Engineering Certificate: Harvard Extension School</strong></p>
        <p>Classes included Programming Microsoft .NET, Systems Programming and Machine Organization, and Software Design</p>
        <p>&nbsp;</p>
        ...
        <ul>
          <li>jQuery-based mobile application for determining local weather and news using Yahoo and Google API&rsquo;s</li>
        ...
        <ul>
          ...
          <li>Music composition software for young students built in java utilizing the libgdx library for cross-platform deployment: processes PCM audio data, utilizes the web audio javascript API, visualizes music in a sequencer, and renders standard music notation<em></em></li>
        </ul>
        <p><em></em></p>
        ...
        <ul>
          ...
          <li>Thesis: Designed cross-platform music composition software to foster creativity for young students that processes audio, visualizes music in a sequencer, and renders standard music notation<em> </em></li>
        </ul>
        ...
        <ul>
          ...
          <li>Academic Honors: Dean&rsquo;s List for seven semesters, Graduated with distinction</li>
        </ul>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        ...
        <ul>
          ...
          <li><strong>Presenter:</strong> Presenter for staff development sessions for the Fine Arts Department of St. Mary&rsquo;s County Public Schools. Presented on use of technology for administrative tasks, Japanese music and activities, and a comparison of band method books.</li>
